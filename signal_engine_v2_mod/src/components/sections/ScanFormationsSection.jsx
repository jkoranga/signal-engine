        ...
        <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:18}}>
          ...
          <div style={{flex:1}}>
            <div style={{display:'flex',alignItems:'center',gap:8,flexWrap:'wrap'}}>
              ...
              {isAdv && <span style={{fontSize:9,fontFamily:'var(--mono)',fontWeight:800,padding:'2px 7px',borderRadius:6,background:'rgba(150,100,255,0.15)',color:'#b388ff',border:'1px solid rgba(150,100,255,0.4)'}}>ADVANCED</span>}
            </div>
      ...
      <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:12}}>
        ...
        <div style={{flex:1,minWidth:0}}>
          <div style={{display:'inline-flex',alignItems:'center',gap:6,flexWrap:'wrap'}}>
            ...
            {isAdv && <span style={{fontSize:8,fontFamily:'var(--mono)',fontWeight:800,padding:'2px 6px',borderRadius:5,background:'rgba(150,100,255,0.15)',color:'#b388ff',border:'1px solid rgba(150,100,255,0.3)'}}>ADV</span>}
          </div>
        </div>
        <TvIcon symbol={alert.symbol} timeframe={alert.timeframe}/>
      </div>
    ...
    <div className="fade-in" onClick={()=>onTap(alert)} style={{
      ...
      <div style={{flex:1,minWidth:0}}>
        <div style={{display:'flex',alignItems:'center',gap:7,flexWrap:'wrap',marginBottom:3}}>
          ...
          <span className={`badge ${isBull?'badge-green':'badge-red'}`} style={{fontSize:9}}>{isBull?'BULL':'BEAR'}</span>
          {alert.group==='advanced' && <span style={{fontSize:8,fontFamily:'var(--mono)',fontWeight:800,padding:'1px 5px',borderRadius:4,background:'rgba(150,100,255,0.15)',color:'#b388ff',border:'1px solid rgba(150,100,255,0.3)'}}>ADV</span>}
        </div>
      ...
      <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',gap:10,marginBottom:10,flexWrap:'wrap'}}>
        <div>
          ...
          <p style={{fontSize:11,color:'var(--text3)',fontFamily:'var(--mono)'}}>
            {loadingSyms?'⟳ Loading Binance…':`${settings.timeframe} · ${symbols.length} symbols · ${activeScanners.length}/${ALL_SCANNERS.length} patterns`}
          </p>
        </div>
        {scanMode!=='single'&&(
